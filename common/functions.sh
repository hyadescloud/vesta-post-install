...
php_fpm_install() {
    ...
    apt-get install -y php$VERSION php$VERSION-common php$VERSION-json php$VERSION-xsl libapache2-mod-php$VERSION php$VERSION-opcache php$VERSION-readline php$VERSION-bz2  php$VERSION-apcu php$VERSION-mbstring php$VERSION-bcmath php$VERSION-cli php$VERSION-curl php$VERSION-fpm php$VERSION-gd php$VERSION-intl php$VERSION-mysql php$VERSION-soap php$VERSION-xml php$VERSION-zip php$VERSION-memcache php$VERSION-memcached php$VERSION-zip php$VERSION-gmp
